...
CGLObjects* CGLObjects::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	return NULL;
}
...
void CGLObjects::Serialize(CArchive& ar)
{
	...
	{
		m_pDocument = (CGL_OneDoc*)ar.m_pDocument;
		BYTE bColor, bComp, bConvex;
		ar >> m_color[0] >> m_color[1] >> m_color[2];
		ar  >>	bColor  >>	m_Alpha >>	bComp >> bConvex;
		ar >> m_strDescriptor;
...
CGLObjects* CGLBox::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
...
CGLObjects* CGLComp::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
...
CGLObjects* CGLCone::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
...
CGLObjects* CGLDisk::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
...
CGLObjects* CGLPolygon::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
...
CGLObjects* CGLSphere::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
...
CGLObjects* CGLTeapot::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
...
CGLObjects* CGLTorus::Repeat(GLuint copies, GLdouble* offset, CGL_OneDoc* pDoc)
{
	GLdouble XOffset = offset[0];
	GLdouble YOffset = offset[1];
	GLdouble ZOffset = offset[2];
